...
class SDKTest<T> implements ISDKTest {
    List<ISDKCase<T>> mCases = new ArrayList<>();
    List<ISDKVerify> mVerifies = new ArrayList<>();
...
public class AssembleEventTest {
    ...
    public void init() {
        ...
        sdk = new TDAnalytics(consumer, false, isStrictModel);
    }
    ...
    <T> void setUpEventCase(final String accountId, final String distinctId, final String eventName,
        ...
        sdkTest.addCase(new ISDKCase<T>() {
            ...
            public T doAction() {
                try {
                    System.out.println("[trackUpdate]properties=" + properties);
            ...
            public T doAction() {
                try {
                    System.out.println("[trackOverwrite]properties=" + properties);
            ...
            public T doAction() {
                try {
                    ...
                    System.out.println("[trackFirst]properties=" + properties);
                    sdk.trackFirst(accountId, distinctId, eventName, "firstCheckId", properties);
    ...
    <T> void setUpUserPropertyCase(final String accountId, final String distinctId,
        ...
        sdkTest.addCase(new ISDKCase<T>() {
            ...
            public T doAction() {
                try {
                    System.out.println("[userSet]properties=" + properties);
            ...
            public T doAction() {
                try {
                    System.out.println("[userSetOnce]properties=" + properties);
            ...
            public T doAction() {
                try {
                    ...
                    System.out.println("[userAppend]properties=" + properties);
                    sdk.userAppend(accountId, distinctId, appendProperties);
            ...
            public T doAction() {
                try {
                    ...
                    sdk.userUnset(accountId, distinctId, "a");
                } catch (InvalidArgumentException e) {
                    return (T) e;
                }
                return result[3];
            ...
            public T doAction() {
                ...
                try {
                    System.out.println("[userAdd]properties=" + properties);
                    sdk.userAdd(accountId, distinctId, addProperties);
                } catch (InvalidArgumentException e) {
                    return (T) e;
                }
                return result[4];
            ...
            public T doAction() {
                try {
                    ...
                    sdk.userDelete(accountId, distinctId);
                } catch (InvalidArgumentException e) {
                    return (T) e;
                }
                return result[5];
            ...
            public T doAction() {
                try {
                    ...
                    sdk.userUniqAppend(accountId, distinctId, appendProperties);
                } catch (InvalidArgumentException e) {
                    return (T) e;
                }
                return result[6];
    ...
    <T> SDKTest setUpUserAdd(final String accountId, final String distinctId, final Map<String, Object> properties,
        ...
        sdkTest.addCase(new ISDKCase() {
            ...
            public Object doAction() {
                try {
                    sdk.userAdd(accountId, distinctId, properties);
                } catch (InvalidArgumentException e) {
                    return (T) e;
                }
                return result;
    ...
    public void testEmptyEventId() {
        ...
        test.addCase(new ISDKCase<Exception>() {
            ...
            public Exception doAction() {
                try {
                    sdk.trackUpdate("accountId", "", "eventName", "", new HashMap<String, Object>());
                } catch (InvalidArgumentException e) {
                    return e;
                }
                return null;
        ...
        test.addCase(new ISDKCase<Exception>() {
            ...
            public Exception doAction() {
                try {
                    sdk.trackOverwrite("accountId", "", "eventName", "", new HashMap<String, Object>());
                } catch (InvalidArgumentException e) {
                    return e;
                }
                return null;
        ...
        test.addCase(new ISDKCase<Exception>() {
            ...
            public Exception doAction() {
                try {
                    sdk.trackFirst("accountId", "", "eventName", null, new HashMap<String, Object>());
                } catch (InvalidArgumentException e) {
                    return e;
                }
                return null;
    ...
    public void testEventId() {
        ...
        test.addCase(new ISDKCase<Exception>() {
            ...
            public Exception doAction() {
                try {
                    sdk.trackUpdate("accountId", "", "eventName", "eventId", new HashMap<String, Object>());
                } catch (InvalidArgumentException e) {
                    return e;
                }
                return null;
        ...
        test.addCase(new ISDKCase<Exception>() {
            ...
            public Exception doAction() {
                try {
                    sdk.trackOverwrite("accountId", "", "eventName", "eventId", new HashMap<String, Object>());
                } catch (InvalidArgumentException e) {
                    return e;
                }
                return null;
        ...
        test.addCase(new ISDKCase<Exception>() {
            ...
            public Exception doAction() {
                try {
                    sdk.trackFirst("accountId", "", "eventName", "eventId", new HashMap<String, Object>() {
                        {
    ...
    public void testUUID() {
        ...
        sdk = new TDAnalytics(consumer, true);
        expect = null;
        try {
            sdk.track("accountId", "distinctId", "eventName", properties);
        } catch (Exception e) {
